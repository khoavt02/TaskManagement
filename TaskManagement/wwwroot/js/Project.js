...
function js_AddProject() {
    ...
    //    Toast("Thông báo", "Vui lòng nhập đầy đủ mã dự án và tên dự án", "error");
    //    return;
    //}
    //if (project_description == "" && fileInput == null) {
    //    Toast("Thông báo", "Vui lòng nhập mô tả hoặc thêm file đính kèm", "error");
    //    return;
    //}
